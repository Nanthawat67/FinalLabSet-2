...
| ------------- | -------------------- | -------- |
| 67543210034-4 | นายนันทวัฒน์ แซ่ย่าง      | Backend  |
| 67543210030-2 | นายธนกร ผดุงศิลป์ | Frontend |
...
| Service          | URL                                               |
| ---------------- | ------------------------------------------------- |
| Auth Service     | `https://auth-service-production-a741.up.railway.app`        |
| Task Service     | `https://task-service-production-d73b.up.railway.app`   |
| Activity Service | `https://activity-service-production-4636.up.railway.app` |
...
```javascript
window.APP_CONFIG = {
  AUTH_URL: "https://auth-service-production-a741.up.railway.app",
  TASK_URL: "https://task-service-production-d73b.up.railway.app",
  ACTIVITY_URL: "https://activity-service-production-4636.up.railway.app",
};
```
...
cd FinalLabSet-2.git
cd final-lab-sec2-set2-[student1]-[student2]
